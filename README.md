...
O grupo de telegram *dockerbr* é um local de muitas trocas de experiências, entretanto muito conhecimento está perdido no histórico gigantesco da conversa.
...
Pergunte sobre:
- Como resolver um determinado problema ex: `Meu container cai toda hora que inicializo`.
- Como executar uma determinada tarefa ex: `Como criar um cluster no Swarm`.
...
Descobriu uma ferramenta, ou outro recurso que possa ajudar os membros do grupo? Não hesite em compartilhar conosco estamos ansiosos pela sua dica.

### Geral

Caso seu post não se encaixe em nenhuma das categorias acima, não tem problema. Desde que ele trate sobre Docker e seu ecossistema estaremos dispostos a discutir e ajudar.
